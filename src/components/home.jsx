    ...
    <>
        <section id='hero-section' className='z-0 relative'>
            ...
            <div className="dots z-20 absolute top-full flex gap-4 justify-center items-center w-full">
                <div className='BTN rounded-full bg-indigo-700  cursor-pointer w-4 h-4'></div>
                <div className='BTN rounded-full bg-indigo-700  cursor-pointer w-4 h-4'></div>
                <div className='BTN rounded-full bg-indigo-700  cursor-pointer w-4 h-4'></div>
                <div className='BTN rounded-full bg-indigo-700  cursor-pointer w-4 h-4'></div>
                <div className='BTN rounded-full bg-indigo-700  cursor-pointer w-4 h-4'></div>
        ...
        <section id='wedding' className=' px-16 py-20  ' style={{ paddingTop: "180px" }}>
            ...
            <div class="gallery w-full  flex justify-center items-center gap-3">
                <div className="column w-full  flex flex-col justify-center items-center gap-3">
                    <div className="image rounded-md overflow-hidden w-full tall"><img className=' w-full h-auto ' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7sKEuv_9IFjIeqO-zqhWo3LbsFyCztRer4A&s" alt="" /></div>
                    <div className="image rounded-md overflow-hidden w-full mid"><img className=' w-full h-auto ' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQiI76D9VIJtd-mUicPtv07vgr1ZcKobACqyg&s" alt="" /></div>
                ...
                <div className="column w-full  flex flex-col justify-center items-center gap-3">
                    <div className="image rounded-md overflow-hidden w-full md"><img className=' w-full h-auto ' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQiI76D9VIJtd-mUicPtv07vgr1ZcKobACqyg&s" alt="" /></div>
                    <div className="image rounded-md overflow-hidden w-full tall"><img className=' w-full h-auto ' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7sKEuv_9IFjIeqO-zqhWo3LbsFyCztRer4A&s" alt="" /></div>
                    <div className="image rounded-md overflow-hidden w-full sm"><img className=' w-full h-auto ' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSCZlf5lc5tX-0gY-y94pGS0mQdL-D0lCH2OQ&s" alt="" /></div>
                </div>
                <div className="column w-full  flex flex-col justify-center items-center gap-3">
        ...
        <section id='cenematic-shot' className='my-32 relative'>
            <div className="title w-10/12 mx-auto  text-center">
                <p className=' uppercase text-7xl raleway-font'>cenematic videos</p>
            ...
            <div id="videos" className=' -mt-24 px-10'>
                <div className="video1 my-28 flex justify-between items-center ">
                    <video className='w-5/12 rounded-lg' src="/1.mp4" autoPlay loop muted></video>
                    <div className=" w-6/12 content text-3xl font-thin font-sans text-orange-50">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet earum eum sit, iste neque esse </div>
                </div>
                <div className="video2 my-28 flex flex-row-reverse justify-between items-center ">
                    <video className='w-5/12 rounded-lg' src="/1.mp4" autoPlay loop muted></video>
                    <div className=" w-6/12 content text-3xl font-thin font-sans text-orange-50">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet earum eum sit, iste neque esse </div>
                </div>
            </div>
