...
const MeetTheArtist = () => {
  return (
    <div id='meetTheArtist' className=' bg-[#D2E0FB] py-24'>
        <div className='md:flex md:flex-row flex-none justify-center items-center md:w-7/12 mx-auto px-4'>
            <div className="img w-1/3 sm:mx-4 mr-3 md:my-10 mt-6 mb-3 md:float-none float-left "><img src="/a/seb-dean-yOSEqRsOAnE-unsplash.jpg" alt="" className=' w-full object-cover object-center' style={{aspectRatio:"1/1"}} /></div>
