  ...
  return (
    <div id='navbar' className='bg-transparent fixed top-0 w-full z-50 overflow-hidden dosis-font font-thin pt-4' style={{backgroundImage:"linear-gradient(to bottom , transparent , transparent)"}}>
        <div className=' flex justify-between items-center'>
            ...
            <div className="menu flex justify-center items-center capitalize mr-16 text-[#F6F5F2]" style={{fontFamily:"inherit"}}>
                ...
                <div className=' ms-5 transition-all duration-500 hover:underline font-normal cursor-pointer'><a href='#contact'>about me</a></div>
                <div className=' ms-5 transition-all duration-500 hover:underline font-normal cursor-pointer'><a href='#contact'>contact</a></div>
            </div>
        </div>
    </div>
  )
