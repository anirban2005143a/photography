...
const navbar = () => {
  return (
    <div id='navbar' className='bg-transparent absolute top-0 w-full z-50 overflow-hidden dosis-font font-thin pt-4' style={{backgroundImage:"linear-gradient(to bottom , transparent , transparent)"}}>
        <div className=' flex justify-between items-center'>
            ...
            <div className="menu flex justify-center items-center capitalize mx-5 text-[#F6F5F2]" style={{fontFamily:"inherit"}}>
                ...
                <div className=' ms-5 transition-all duration-500 hover:underline font-normal cursor-pointer'><a href='#cenematic-shot'>flim</a></div>
